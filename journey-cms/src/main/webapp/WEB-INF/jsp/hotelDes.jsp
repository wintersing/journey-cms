...
<div class="page-container">
		<form id="places" action="/hotelEdit" method="POST" class="form form-horizontal" id="form-article-add">
		<input type="hidden" class="input-text" value="${hotelItem.id }" placeholder="" id="" name="id">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${hotelItem.title }" placeholder="输入标题" id="title" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">品牌：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${hotelItem.brandName }" placeholder="输入子标题" id="" name="brandName">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">市区：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${hotelItem.district }" placeholder="" id="" name="district">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">星级：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input disabled="disabled" type="text" class="input-text" value="${hotelItem.level }" placeholder="输入国家" id="" name="level">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input disabled="disabled" type="text" class="input-text" value="${hotelItem.rating }" placeholder="" id="" name="rating">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="recommend" class="select">
					...
					<option id="2" value="2">酒店推荐</option>
				</select>
				</span>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input disabled="disabled" type="text" class="input-text" value="${hotelItem.updatetime }" placeholder="" id="" name="updatetime">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<textarea rows="10" cols="134" name="description">${hotelItem.description }
				</textarea>
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<button class="btn btn-default radius" type="button"><a href="/hotel">&nbsp;&nbsp;返回&nbsp;&nbsp;</a></button>
			</div>
		</div>
	</form>
</div>
...
$(document).ready(function() { 
	$("#${hotelItem.recommend }").attr("selected",true); 
	if ('${reqURI }' == '/hotelEdit') {
		layer.msg('修改成功！', {
			icon : 1,
			time : 1650
